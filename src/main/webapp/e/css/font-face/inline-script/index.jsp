...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Delaying inline font-face when loading script first</title>
  ...
  src: url("/font/lRguYfMfWArflkm5aOQ5QNNNRtILQnhF8IuY18ihom0.woff?delay=10") format('woff');
	...
	<body>
      ...
      <hr>
      <div class="jumbotron">
	       	<h2>Delaying inline font-face when loading script first</h2>
	 </div>	
	 <div class="row-fluid">
        <div class="span12">
		<p>The font-face file is delayed for ten seconds.</p>
