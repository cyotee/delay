...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
    <title>Loading three javascript files just before the end body tag</title>
	...
	<body>
	 <div class="container-narrow">
      ...
      <hr>
      <div class="jumbotron">
	       	<h2>Loading three javascript files just before the end body tag</h2>
	 </div>	
	 <div class="row-fluid">
        <div class="span12">
		<p>Each file is delayed for 5 seconds. 
